<div>
    ...
    @if ($attempts->isEmpty())
        <flux:card class="text-center py-12">
            ...
            <flux:text>You haven't completed any quizzes yet. Start taking quizzes to see your results here!</flux:text>
            <flux:button href="{{ route('participant.quizzes') }}" variant="primary" class="mt-4">
                Browse Quizzes
            </flux:button>
        </flux:card>
    @else
